...
//    MatchStrategyEnum::External   => 'External',
  ...
  'er.auth.org' =>    'The login identifier "%1$s" is not yet registered. If you have already requested enrollment, your application is still being processed. You will be able to login once your application is approved.',
  'er.auth.roles' =>  'You are not yet registered as an Cosmic Explorer member. If you have already requested enrollment, your application is still being processed. You wll be able to login once your application is approved.',
  ...
  'rs.pt.confirm' =>  'Application Confirmed. Please wait for an administrator to approve your application. You will receive an email once your application has been approved.',
  ...
  'rs.pt.create.self' => 'Application to join Cosmic Explorer created. Please look for an email from comanage-do-not-reply@np3m.org and follow the instructions to complete sign up.', 
